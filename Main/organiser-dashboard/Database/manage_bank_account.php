...
$sql = "SELECT id FROM organiser_accounts WHERE user_id = ?";
...
// Prepare and bind
$sql = "INSERT INTO organiser_accounts (user_id, account_number, ifsc_code, bank_name, branch_name, account_holder_name, upi_id, upi_number) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
if ($stmt = $conn->prepare($sql)) {
